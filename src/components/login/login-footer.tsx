...
export function LoginFooter(): JSX.Element {
  return (
    <div style={{borderTop: '1px dashed white;'}}>
      <footer className='hidden justify-center p-4 text-sm text-light-secondary dark:text-dark-secondary lg:flex' >
        <nav className='flex flex-wrap justify-center gap-4 gap-y-2'>
          ...
          <p><span style={{color: 'rgb(64, 228, 84)'}}>ALWAYS INVERSE CRAMER</span> — CRAMER TWITTER IS NOT AFFILIATED WITH JIM CRAMER NOR TWITTER IN ANY WAY!</p>
        </nav>
      </footer>
    </div>
  );
